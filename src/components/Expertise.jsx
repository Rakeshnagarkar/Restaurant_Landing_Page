...
const containerVariants = {
  ...
  show: {
    opacity: 1,
    transition: { 
      staggerChildren: 0.5, // Delay between each image's appearance
    },
  },
};
...
const itemVariants = {
  ...
  show: {
    ...
    y: 0,
    transition: {
      duration: 2, // Adjusted to make each image appear slowly
    },
  },
};
...
function Expertise() {
  return (
    <section id="expertise">
      ...
      <motion.div
        initial="hidden"
        whileInView="show" // Triggers animation when the container comes into view
