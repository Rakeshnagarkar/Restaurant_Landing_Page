...
const containerVariants = {
  ...
  show: {
    opacity: 1,
    transition: {
      staggerChildren: 0.8, // This controls the stagger of each image
    },
  },
};
...
const itemVariants = {
  ...
  show: {
    opacity: 1,
    y: 0,
    transition: { duration: 1 }, // Controls the speed of each item fade-in
  },
};
  ...
  return (
    <section className="container mx-auto mb-8 mt-12" id="review">
      <motion.div
        ...
        viewport={{ once: true }} // Triggers animation when the section comes into view
      ...
      <motion.div
        ...
        whileInView="show"
        variants={containerVariants}
        viewport={{ once: true }} // Ensures the images only animate once they enter the viewport
